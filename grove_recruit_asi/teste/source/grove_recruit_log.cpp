...
void LogInit()
{
    ...
    fprintf(g_logFile,
        ...
        "      m_nDoorStatus=0 directo + SetDoorStatus loop. RepairCarVisualDamage\n"
        "      chamada imediatamente ao entrar no carro.\n"

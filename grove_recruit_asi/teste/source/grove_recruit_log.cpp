...
void LogInit()
{
    ...
    fprintf(g_logFile,
        ...
        "\n"
        "  22. REVERSE PER-FRAME CLEAR: tempAction=REVERSE limpo per-frame em PASSENGER\n"
        "      e CIVICO escort. Log v5.3 mostrou REVERSE persistente durante sessoes inteiras.\n"
        "      SA engine re-aplica REVERSE se dest atras — nos limpamos para forcar U-turn.\n"

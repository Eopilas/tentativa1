...
void LogInit()
{
    ...
    fprintf(g_logFile,
        ...
        "      LOGGING: curveBrake e deltaH re-adicionados a CIVICO_DRIVE_1 para diagnostico.\n"
        "      VERIFICAR: physSpeed < 30kmh em curvas (curveBrake=1).\n"
        "      VERIFICAR: style=0(STOP_FOR_CARS) quando dist<20m.\n"
        "      VERIFICAR: recruta NAO corta calcada em curvas proximas.\n"
        "      VERIFICAR: recruta para ATRAS do jogador, NAO ao lado.\n"
        "\n"

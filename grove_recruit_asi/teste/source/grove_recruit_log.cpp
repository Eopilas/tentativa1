...
void LogInit()
{
    ...
    fprintf(g_logFile,
        ...
        "\n"
        "  11. CIVICO HIBRIDO ESCORT_REAR_FARAWAY + GOTOCOORDS:\n"
        "      - Close + on-road (dist<50m, linkId valido, !offroad): MC67(ESCORT_REAR_FARAWAY).\n"
        "        Road-graph seguimento in-lane ate posicao atras do jogador.\n"
        "        m_nStraightLineDistance=5 previne MC67→MC31 prematura.\n"
        "        AVOID_CARS preservado (MC31 forcava STOP_FOR_CARS).\n"
        "      - Far (dist>50m) ou off-road: GOTOCOORDS(8) para catch-up.\n"
        "      VERIFICAR: mission=67(ESCORT_REAR_FARAWAY) no log quando perto?\n"
        "        driveStyle=2(AVOID_CARS)? straightLineDist=5?\n"
        "        Recruta fica ATRAS sem ultrapassar? Segue curvas do jogador?\n"
        "\n"
        ...
        "\n"
        "  v5.3 MUDANCAS:\n"
        "  14. MC67 EM VEZ DE MC31: Log v5.1 mostrou MC31 (ESCORT_REAR) a forcar\n"
        "      driveStyle=STOP_FOR_CARS via engine override. Recruta parava atras de\n"
        "      trafego e perdia jogador. MC67 preserva AVOID_CARS e road-graph.\n"
        "      VERIFICAR: driveStyle=2(AVOID_CARS) nos logs vs 0(STOP_FOR_CARS) antigo.\n"
        "\n"
        ...
        "\n"
        "  17. CLOSE-RANGE SPEED: 5 zonas refinadas (v5.4):\n"
        "      >40m: SPEED_PASSENGER(70) catch-up | 30-40m: playerSpeed+8 cap 70\n"
        "      15-30m: playerSpeed+3 cap 46 | 10-15m: playerSpeed-5 cap 46\n"
        "      <10m: playerSpeed-8 cap 46 (desaceleracao forte)\n"
        "      v5.4: <15m agora mais LENTO que jogador para criar gap natural.\n"
        ...
        "      Seguro porque MC67 usa road-graph para curvas nativamente.\n"
        ...
        "      CLOSE_RANGE_STRAIGHT_LINE_DIST 5→3m: MC67 fica activa mais tempo.\n"
        "      VERIFICAR: mission=67(ESCORT_REAR_FARAWAY) no log, nao 31(ESCORT_REAR).\n"
        "\n"
        "  v5.5 MUDANCAS:\n"
        ...
        "\n"
        "  27. MC67 PER-FRAME INCONDICIONAL (v5.5, removido v5.6 — MC67 descontinuado).\n"
        "\n"

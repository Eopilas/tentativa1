...
void LogInit()
{
    ...
    fprintf(g_logFile,
        ...
        "      MANTEVE: Speed zones (dist-based), lane hold (player stopped),\n"
        "        teleport catch-up (>100m), stuck recovery, REVERSE clearing.\n"
        "      Referencia gta-reversed: CCarAI::UpdateCarAI processa FOLLOWCAR.\n"
        "      VERIFICAR: mission=52(FOLLOWCAR_FARAWAY) ou 53(FOLLOWCAR_CLOSE).\n"
        "      VERIFICAR: targetCar=PLAYER (nao NULL nem OTHER).\n"
        "      VERIFICAR: recruta segue na faixa atras do jogador.\n"
        "      VERIFICAR: em cruzamentos, recruta segue o mesmo caminho.\n"
        "      VERIFICAR: recruta para atras do jogador quando jogador para.\n"
        "      VERIFICAR: recruta NAO fica de lado nem sobe calcada.\n"
        "\n"

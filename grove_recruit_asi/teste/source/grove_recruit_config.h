...
// v4.9: CIVICO_GOTOCOORDS usa o mesmo intervalo do PASSENGER/DIRETO para rotas estaveis.
static constexpr int CIVICO_GOTOCOORDS_UPDATE_INTERVAL = DIRETO_UPDATE_INTERVAL;  // 1.0s
